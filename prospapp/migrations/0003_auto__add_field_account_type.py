...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.type'
        db.add_column(u'prospapp_account', 'type',
                      self.gf('django.db.models.fields.CharField')(default=('CANDIDATE', 'Candidate'), max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.type'
        db.delete_column(u'prospapp_account', 'type')
    ...
    models = {
        ...
        u'prospapp.account': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "('CANDIDATE', 'Candidate')", 'max_length': '31'}),
