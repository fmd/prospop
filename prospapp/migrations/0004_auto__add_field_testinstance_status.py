...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestInstance.status'
        db.add_column(u'prospapp_testinstance', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestInstance.status'
        db.delete_column(u'prospapp_testinstance', 'status')
