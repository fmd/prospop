...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestAuth'
        db.create_table(u'prospapp_testauth', (
            ...
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authorizations', to=orm['prospapp.Test'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authorized_tests', blank=True, to=orm['prospapp.Account'])),
        ...
        db.send_create_signal(u'prospapp', ['TestAuth'])


    def backwards(self, orm):
        # Deleting model 'TestAuth'
        db.delete_table(u'prospapp_testauth')
    ...
    models = {
        ...
        u'prospapp.testauth': {
            'Meta': {'object_name': 'TestAuth'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authorizations'", 'to': u"orm['prospapp.Test']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authorized_tests'", 'blank': 'True', 'to': u"orm['prospapp.Account']"})
        },
