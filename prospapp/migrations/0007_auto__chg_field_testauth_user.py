...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestAuth.user'
        db.alter_column(u'prospapp_testauth', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['prospapp.Account']))

    def backwards(self, orm):

        # Changing field 'TestAuth.user'
        db.alter_column(u'prospapp_testauth', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['prospapp.Account']))
    ...
    models = {
        ...
        u'prospapp.testauth': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'authorized_tests'", 'null': 'True', 'to': u"orm['prospapp.Account']"})
        },
