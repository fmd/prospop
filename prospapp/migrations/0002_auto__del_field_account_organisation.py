...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.organisation'
        db.delete_column(u'prospapp_account', 'organisation')


    def backwards(self, orm):
        # Adding field 'Account.organisation'
        db.add_column(u'prospapp_account', 'organisation',
